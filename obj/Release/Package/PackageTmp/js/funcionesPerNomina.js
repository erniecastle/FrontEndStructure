...
function mostrarFormaCaptura(ocultar) {
    if (!ocultar) {
        if (tipoNomina === null) {
            ...
            document.getElementById("txtEjercicio1").value = document.getElementById("txtEjercicio").value;
            ...
            document.getElementById("txtFechaCorte").value = formatDate(fechaSistemas);
...
function construirPeriodo() {
    ...
    periodoNominaAux.fechaCierre = formantDdMmYyyy(document.getElementById("txtFechaCorte").value);
    ...
    periodoNominaAux.status = true;
    if (document.getElementById("txtDescripcionb").value.toString().length > 0) {
        periodoNominaAux.detalleConceptoRecibo = document.getElementById("txtDescripcionb").value;
    }
...
function SubConfigPeriodosNomina(periodo) {
    ...
    document.getElementById("txtFechaCorte").value = formatDate(new Date(periodo.fechaCierre));
    ...
    document.getElementById("txtDescripcionb").value = periodo.detalleConceptoRecibo;
...
function bloquerModificaciones(habilitar, cerrado) {
    ...
    document.getElementById("txtFechaCorte").disabled = habilitar;
    ...
    document.getElementById("txtDescripcionb").disabled = habilitar;
