...
jQuery(document).ready(function () {
    ...
    document.getElementById("btnTimbrar").style.display = "none-block";
    startCustomTools();
...
function crearListaColumnas() {
    ...
    columnasTabla.push(
        ...
        { "tituloColumna": idiomaSelecionado.messageFormatter("GenerarTimbradoTblFolio")(), "nombreCompo": "folioCFDI", "editable": false, "tipoCompon": "text", "persist": "folioCFDI", "ancho": "40px"},
        { "tituloColumna": "idEmpleado", "nombreCompo": "idEmpleado", "editable": false, "tipoCompon": "text", "persist": "idEmpleado", "ancho": "150px", "hide": true},
        { "tituloColumna": idiomaSelecionado.messageFormatter("EmpleadosClave")(), "nombreCompo": "claveEmpleado", "editable": false, "tipoCompon": "text", "persist": "claveEmpleado", "ancho": "65px"},
        { "tituloColumna": idiomaSelecionado.messageFormatter("EmpleadosNombre")(), "nombreCompo": "nombreEmp", "editable": false, "text": "edit", "persist": "nombreEmp", "ancho": "240px" },
        { "tituloColumna": idiomaSelecionado.messageFormatter("GenerarTimbradoTblFecha")(), "nombreCompo": "fecha", "editable": false, "tipoCompon": "text", "persist": "fecha", "ancho": "85px" },
        { "tituloColumna": idiomaSelecionado.messageFormatter("GenerarTimbradoTblImportePagado")(), "nombreCompo": "importePag", "editable": false, "tipoCompon": "importe", "persist": "importePag", "ancho": "90px" },
        { "tituloColumna": idiomaSelecionado.messageFormatter("GenerarTimbradoTblStatus")(), "nombreCompo": "status", "editable": false, "tipoCompon": "text", "persist": "status", "ancho": "100px" },
        { "tituloColumna": idiomaSelecionado.messageFormatter("GenerarTimbradoTblMensaje")(), "nombreCompo": "mensaje", "editable": false, "tipoCompon": "text", "persist": "mensaje", "ancho": "200px" },
        { "tituloColumna": "Seleccionar", "nombreCompo": "Seleccionar", "editable": true, "tipoCompon": "checkbox", "persist": "seleccionado", "ancho": "70px", "selectable": true, "funcion": "setActivarSeleccionado"}
    );
...
function limpiarComponentes() {
    ...
    document.getElementById("btnTimbrar").style.display = "none";
}
function cancelar() {
...
{     
    ...
    if (listaEmpleadosGenerados.length !== undefined) {
        for (var i = 0; i < listaEmpleadosGenerados.length; i++) {
            ...
            folioCFDi = listaEmpleadosGenerados[i].cfdiRecibo.serie + "" + listaEmpleadosGenerados[i].cfdiRecibo.folioCFDI;
            objEmpleado.folioCFDI = folioCFDi;
            ...
            objEmpleado.importePag = importe_format(listaEmpleadosGenerados[i].cfdiRecibo.total,2,null);
            var statusT = listaEmpleadosGenerados[i].cfdiRecibo.statusTimbrado;
            var totalImporte = (listaEmpleadosGenerados[i].cfdiRecibo.total);
            ...
            if (listaEmpleadosGenerados[i].cfdiRecibo.mensajeRec !== null) {
                if (listaEmpleadosGenerados[i].cfdiRecibo.mensajeRec !== undefined) {
                    objEmpleado.mensaje = objEmpleado.mensaje + listaEmpleadosGenerados[i].cfdiRecibo.mensajeRec;
                }

            }

            objEmpleado.seleccionado = listaEmpleadosGenerados[i].seleccionado;
        ...
        document.getElementById("btnCancelar").style.display = "inline-block";
        document.getElementById("btnTimbrar").style.display = "inline-block";
    }
    else {
...
function desplegarInfo() {
    ...
    if (listaEmpleadosGenerados !== null) {
        if (listaEmpleadosGenerados.length === 0) {
            alert("No hay información generada para timbrar.");
...
function mostrarInformacion(valores) {
    var url = route + "/api/CFDIEmpleado/BuscarInformacionATimbrar";
    ...
    if (obj1 !== null)
     {
        ...
        if (Mensaje.resultado === null) {
            ...
            listaEmpleadosGenerados = Mensaje.resultado;

            if (listaEmpleadosGenerados !== null) {
                if (listaEmpleadosGenerados.length === 0) {
                    alert("No hay información timbradar.");
...
function parametros2() {
    ...
    */
    ...
    obj['ParaTimbrar'] = sendOnlySelected(listaEmpleadosGenerados);

    if (obj['ParaTimbrar'].length === 0) {
        alert("Debe de seleccionar por lo menos un empleado a timbrar");
        return  null;
    }
    else {
        return obj;
